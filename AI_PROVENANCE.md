...
| **Legibility Font Refinement (Unslashed Zero)** | `v1.0.3` | Antigravity CLI (`agy 1.2.6`, `Gemini 3.8 Flash (High)`) | Switched default font family to `Liberation Mono` so numerals render without a slashed 0, eliminating visual confusion between 10 and 18 at small font sizes across panel cards and curve timeline readouts while preserving monospaced tabular alignment. |
