...
| **Marketplace notification security fix** | `v1.0.4` unreleased | Codex CLI (`codex 0.155.1`, `gpt-6-sol`) | Replaced shell-built right-click notification command with a bounded literal argv call through a closed-environment process and watchdog; updated renamed repository links. |
