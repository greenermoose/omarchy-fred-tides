...
// Dedicated tides popup panel with multi-monitor focus isolation.
//
...
//    monitor while tides is showing on the side monitor), WlrKeyboardFocus is
...
PanelWindow {
  ...
  property int contentWidth: Style.space(500)
  property int contentHeight: Style.space(380)
  ...
  WlrLayershell.namespace: "omarchy-tides-panel"
